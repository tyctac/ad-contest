...
#建模与交叉验证
#pram: 分类器， 训练数据 ， 测试数据 ， 除了标号以外的header, 是否使用交叉验证
target = 'label'
...
def main2():
    ...
    # save(dfTrain, dfTest, y_train, 'v3')
    x_train_path = config.get_file_path('v1', 'xgboost', 'v3') + 'X_train.npy'
    y_train_path = config.get_file_path('v1', 'xgboost', 'v3') + 'y_train.npy'
    x_test_path = config.get_file_path('v1', 'xgboost', 'v3') + 'X_test.npy'
    y_test_path = config.get_file_path('v1', 'xgboost', 'v3')
